...
answerlist = []
target_data = [
    "./data/Andriatria_男科/男科5-130001.csv",
    "./data/IM_内科/内科5000-330001.csv",
    "./data/OAGD_妇产科/妇产科6-280001.csv",
    "./data/Oncology_肿瘤科/肿瘤科5-100001.csv",
    "./data/Pediatric_儿科/儿科5-140001.csv",
    "./data/Surgical_外科/外科5-140001.csv"
]
